...
static mem_model_dma_pool_item_t *
mem_model_alloc_pool_item(mem_model_cxt_t *mem_model_cxt);
static void mem_model_free_pool_item(mem_model_cxt_t *mem_model_cxt,
                                     mem_model_dma_pool_item_t *pool_item);
static mem_model_dma_pool_item_t *
find_match_dma_pool_cfg(mem_model_cxt_t *mem_model_cxt,
                        mem_model_dma_pool_cfg_t *cfg);
static mem_model_dma_buffer_item_t *
mem_model_new_buffer_item(mem_model_cxt_t *mem_model_cxt);
static void
mem_model_free_buffer_item(mem_model_cxt_t *mem_model_cxt,
                           mem_model_dma_buffer_item_t *buffer_item);
static mem_model_dma_buffer_t *
mem_model_dma_pool_alloc_mem(mem_model_handle_t mem_model_handle,
                             mem_model_dma_pool_cfg_t *cfg, gfp_t gfp_flags);
...
void mem_model_free_buffer(void *buf) { kfree(buf); }

void mem_model_memset(void *s, int c, unsigned int n) { memset(s, c, n); }
...
char *mem_model_strdup(const char *str) { return kstrdup(str, GFP_KERNEL); }

void *mem_model_alloc_dma_buffer(mem_model_handle_t mem_model_handle,
                                 unsigned int size,
                                 mem_model_dma_buffer_t *dma_buffer) {
...
#else
    vaddr =
        dma_zalloc_coherent(mem_model_cxt->dev, size, &dma_addr, GFP_KERNEL);
// mesg("%s\n",__func__);
#endif
...
void mem_model_free_dma_buffer(mem_model_handle_t mem_model_handle,
                               mem_model_dma_buffer_t *dma_buffer) {
  mem_model_cxt_t *mem_model_cxt = mem_model_handle;
  if (dma_buffer) {
    dma_free_coherent(mem_model_cxt->dev, dma_buffer->size, dma_buffer->vaddr,
...
mem_model_dma_pool_alloc_mem(mem_model_handle_t mem_model_handle,
  ...
  if (!dma_pool) {
    ...
    pool = dma_pool_create(cfg->name, mem_model_cxt->dev, cfg->size, cfg->align,
                           cfg->boundary);
    if (pool) {
...
mem_model_dma_pool_alloc(mem_model_handle_t mem_model_handle,
                         mem_model_dma_pool_cfg_t *cfg) {
  return mem_model_dma_pool_alloc_mem(mem_model_handle, cfg, GFP_KERNEL);
}

mem_model_dma_buffer_t *
mem_model_dma_pool_alloc_atomic(mem_model_handle_t mem_model_handle,
                                mem_model_dma_pool_cfg_t *cfg) {
...
mem_model_dma_buffer_t *
mem_model_dma_pool_alloc_video(mem_model_handle_t mem_model_handle) {
  return mem_model_dma_pool_alloc_mem(mem_model_handle, &dma_pool_cfg,
                                      GFP_ATOMIC);
}
...
mem_model_dma_buffer_t *
mem_model_dma_pool_alloc_audio(mem_model_handle_t mem_model_handle) {
  return mem_model_dma_pool_alloc_mem(mem_model_handle, &audio_dma_pool_cfg,
                                      GFP_ATOMIC);
}

void mem_model_dma_pool_free(mem_model_handle_t mem_model_handle,
                             mem_model_dma_buffer_t *dma_buffer) {
  mem_model_cxt_t *mem_model_cxt = mem_model_handle;
  mem_model_dma_buffer_item_t *buffer_item;
  ...
  if (dma_buffer) {
    buffer_item =
        container_of(dma_buffer, mem_model_dma_buffer_item_t, dma_buffer);

    mem_model_free_buffer_item(mem_model_cxt, buffer_item);
  }
}

mem_model_pool_handle_t
mem_model_create_pool(mem_model_handle_t mem_model_handle, unsigned int size) {
...
void *mem_model_new(unsigned int size) { return vmalloc(size); }
...
static void *mem_model_alloc(void) {
  mem_model_cxt_t *mem_model_cxt =
      mem_model_alloc_buffer(sizeof(mem_model_cxt_t));
...
static void mem_model_release(void *context) {
  ...
  if (mem_model_cxt) {
    ...
    for_each_queue_entry_safe(pos, next, &mem_model_cxt->dma_pool_queue,
                              queue) {
      if (!queue_empty(&pos->buffer_queue)) {
        mem_model_dma_buffer_item_t *cur_buffer, *next_buffer;
        for_each_queue_entry_safe(cur_buffer, next_buffer, &pos->buffer_queue,
                                  queue) {
          printk("%s %lx size %lx\n", __func__,
                 cur_buffer->dma_buffer.phys_addr, cur_buffer->dma_buffer.size);
...
mem_model_handle_t mem_model_init(cxt_mgr_handle_t cxt_mgr) {
  ...
  do {
    ...
    mem_model_cxt = cxt_manager_add_cxt(cxt_mgr, MEM_CXT_ID, mem_model_alloc,
                                        mem_model_release);
    if (!mem_model_cxt) {
      err = ALLOC_FAIL;
      break;
    ...
    mem_model_cxt->poolitem_mempool =
        mempool_create_kmalloc_pool(MIN_NR, sizeof(mem_model_dma_pool_item_t));
    if (!mem_model_cxt->poolitem_mempool) {
      err = CREATE_POOL_FAIL;
      break;
    }
    mem_model_cxt->bufferitem_mempool = mempool_create_kmalloc_pool(
        MIN_NR, sizeof(mem_model_dma_buffer_item_t));
    if (!mem_model_cxt->bufferitem_mempool) {
      err = CREATE_POOL_FAIL;
      break;
    }
